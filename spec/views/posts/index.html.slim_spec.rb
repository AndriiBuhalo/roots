...
RSpec.describe "posts/index", type: :view do
  ...
  it "renders a list of posts" do
    ...
    expect(rendered).to have_link t('posts.index.show'), href: "/posts/#{valid_post.id}"
    expect(rendered).to have_link t('posts.index.edit'), href: edit_post_path(valid_post)
    expect(rendered).to have_link t('posts.index.destroy'), href: "/posts/#{valid_post.id}".delete
